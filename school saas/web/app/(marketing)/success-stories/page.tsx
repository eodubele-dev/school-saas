            ...
            <main className="pt-32 pb-24 relative overflow-hidden">
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    ...
                    <ScrollReveal className="max-w-6xl mx-auto mb-24">
                        <div className="bento-card bg-[#2A2F3E] border border-white/10 rounded-[32px] overflow-hidden group hover:border-blue-500/50 transition-all">
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                ...
                                <div className="bg-[#1E222D] p-8 md:p-12 border-l border-white/10 relative overflow-hidden flex flex-col justify-center">
                                    {/* Glass reflection */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-24">
                        {[
                            ...
                            <ScrollReveal key={i} delay={0.2 + (i * 0.1)}>
                                <div className="bg-[#2A2F3E] border border-white/10 p-8 rounded-[24px] relative group overflow-hidden hover:border-blue-500/50 transition-colors">
                    ...
                    <div className="max-w-6xl mx-auto columns-1 md:columns-2 lg:columns-3 gap-6">
                        {testimonials.map((t, i) => (
                            <ScrollReveal key={i} delay={0.3 + (i % 3) * 0.1} className="break-inside-avoid mb-6 block w-full">
                                <div className="bg-[#2A2F3E] border border-white/10 p-8 rounded-[24px] flex flex-col justify-between hover:border-blue-500/50 transition-all shadow-lg hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] group h-full">
                                    <div>
