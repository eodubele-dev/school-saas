    ...
    return (
        <div className="space-y-8 p-8 max-w-7xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <button className="h-full min-h-[250px] border border-dashed border-white/10 rounded-xl flex flex-col items-center justify-center text-slate-500 hover:text-white hover:border-white/20 transition-colors gap-3">
