...
export const metadata: Metadata = {
  title: {
    default: "EduFlow | Premium School Management System",
    template: "%s | EduFlow"
  },
  description: "Experience the next generation of institutional management with EduFlow. Seamlessly integrated, hyper-efficient, and beautifully designed.",
};
