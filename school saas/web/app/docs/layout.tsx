                ...
                <aside className="hidden lg:block w-72 shrink-0 border-r border-white/5 h-screen sticky top-0 pt-24 pb-10 overflow-y-auto custom-scrollbar">
                    ...
                    <nav className="px-4 space-y-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <Link href="#" className="flex items-center gap-2 px-2 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-white/5 transition-all">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <Link href="#" className="group flex items-center justify-between px-2 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-white/5 transition-all">
                    ...
                    <div className="absolute bottom-10 px-6">
                        <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/20 rounded-xl p-4">
                            ...
                            <button className="text-[10px] font-bold text-white bg-blue-600 hover:bg-blue-500 px-3 py-1.5 rounded transition-colors w-full">
                                Contact Engineering
                            </button>
                        </div>
                    </div>
