        ...
        return (
            <Card className="bg-card text-card-foreground/50 border-border/50 backdrop-blur-xl">
                ...
                <CardContent className="h-40 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-muted-foreground text-sm">No awards received yet.</p>
                </CardContent>
            </Card>
        )
    }
        ...
        <Card className="bg-card text-card-foreground/50 border-border/50 backdrop-blur-xl">
            <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="text-xs font-mono text-muted-foreground">
                    TOTAL: <span className="text-foreground">{achievements.length}</span>
                </div>
            </CardHeader>
            <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {achievements.map((award) => {
                        ...
                        return (
                            <div key={award.id} className="bg-slate-950/50 border border-border/50 rounded-xl p-4 flex items-start gap-3 group hover:border-yellow-500/30 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1 line-clamp-2">{award.comment}</p>
