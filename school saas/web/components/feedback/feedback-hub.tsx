...
export const FeedbackHub = ({ studentId }: { studentId?: string }) => {
    ...
    return (
        <div className="bg-slate-950/40 backdrop-blur-md border border-border rounded-3xl p-5 shadow-2xl animate-in fade-in duration-500 delay-100">
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-foreground uppercase tracking-tight">Feedback Hub</h2>
                        <p className="text-muted-foreground text-xs">Voice of the Parents</p>
                    </div>
                </div>
            </div>
            ...
            {!submitted ? (
                <>
                    <div className="bg-secondary/50 border border-border/50 rounded-2xl p-5 mb-6 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                            <Star size={80} />
                        </div>
                        <h3 className="text-sm font-bold text-foreground mb-2">How was the Open Day?</h3>
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        star <= rating
                                            ...
                                            : "text-slate-600 hover:text-amber-200 bg-secondary/50 hover:bg-white/10"
                                    )}
                                >
                    ...
                    <div className="space-y-3">
                        <textarea
                            ...
                            className="w-full bg-black/50 border border-border rounded-xl p-4 text-xs text-foreground focus:outline-none focus:border-cyan-500/50 transition-colors h-20 resize-none"
                ...
                <div className="h-full flex flex-col items-center justify-center py-10 animate-in zoom-in duration-300">
                    ...
                    <h3 className="text-xl font-black text-foreground uppercase italic tracking-tight mb-2">Thank You!</h3>
