...
export function VitalSignsHUD({ stats }: VitalSignsProps) {
    return (
        <div className="grid grid-cols-3 gap-3">
            {/* Cash Position */}
            <Card className="bg-card text-card-foreground/50 border-amber-500/20 p-3 flex flex-col justify-between relative overflow-hidden group">
            ...
            {/* Operations */}
            <Card className="bg-card text-card-foreground/50 border-blue-500/20 p-3 flex flex-col justify-between relative overflow-hidden group">
            ...
            {/* Student Safety */}
            <Card className="bg-card text-card-foreground/50 border-red-500/20 p-3 flex flex-col justify-between relative overflow-hidden group">
