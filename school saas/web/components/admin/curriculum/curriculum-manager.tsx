            ...
            <div className="w-full lg:w-80 flex-shrink-0 space-y-4">
                <Card className="bg-[#0A0A0B]/80 backdrop-blur-xl border-border sticky top-8 shadow-2xl overflow-hidden">
                    ...
                    <div className="p-4 border-b border-border/50 relative z-10">
                        <h3 className="font-black text-foreground mb-4 flex items-center gap-2 uppercase tracking-widest text-sm">
                        ...
                        <div className="relative group">
                            ...
                            <Input
                                ...
                                className="pl-9 bg-black/40 border-border text-foreground placeholder:text-muted-foreground focus:border-yellow-500/50 focus:ring-1 focus:ring-yellow-500/50 transition-all rounded-xl"
                                value={searchQuery}
                        ...
                        {filteredStudents.length > 0 ? (
                            <div className="space-y-1">
                                {filteredStudents.map((student) => (
                                    ...
                                    >
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 border shadow-lg ${selectedStudentId === student.id ? 'bg-yellow-600 border-yellow-400 shadow-yellow-500/30' : 'bg-card text-card-foreground border-border'
                                            }`}>
                                        ...
                                        <div className="overflow-hidden">
                                            ...
                                            <p className={`text-[10px] uppercase tracking-widest font-mono truncate ${selectedStudentId === student.id ? 'text-yellow-300' : 'text-muted-foreground'}`}>
            ...
            <div className="flex-1 min-w-0">
                {!selectedStudentId ? (
                    ...
                    <div className="space-y-6">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0A0A0B]/80 backdrop-blur-xl p-6 rounded-3xl border border-border shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="flex items-center gap-4 relative z-10">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 border border-blue-400/50 flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.4)]">
                                    <FileText className="text-foreground drop-shadow-md" size={28} />
                                </div>
                                <div>
                                    <h2 className="text-3xl font-black text-foreground tracking-tight">{selectedStudent?.full_name?.split(' ')[0]}'s Roadmap</h2>
                            ...
                            <Button
                                ...
                                className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 text-foreground font-bold shadow-[0_0_20px_rgba(239,68,68,0.4)] relative z-10 rounded-xl px-6 py-6 text-md border border-red-400/50 hover:scale-105 transition-all"
                            >
