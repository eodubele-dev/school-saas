    ...
    return (
        <div className="p-6 space-y-6">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-foreground tracking-tight glow-blue">Revenue & Collections</h1>
                    <p className="text-muted-foreground">Manage school fee recovery and online settlements.</p>
                </div>
            ...
            <Tabs defaultValue="debtors" className="w-full" onValueChange={setActiveTab}>
                <div className="flex items-center justify-between gap-4 mb-4">
                    <TabsList className="bg-card text-card-foreground border border-border/50 p-1">
                        <TabsTrigger
                            value="debtors"
                            className="data-[state=active]:bg-[var(--school-accent)] data-[state=active]:text-foreground transition-all"
                        >
