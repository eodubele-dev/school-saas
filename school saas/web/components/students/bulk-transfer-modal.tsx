            ...
            <DialogContent className="bg-slate-950 border-border text-foreground sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-muted-foreground">
                        You are about to move <span className="text-foreground font-bold">{studentIds.length}</span> students to a new class.
                    </DialogDescription>
                </DialogHeader>

                <div className="grid gap-4 py-4">
                    <div className="flex items-center justify-center p-4 bg-secondary/50 rounded-lg border border-border">
                        <div className="text-center">
                            <p className="text-[10px] uppercase text-muted-foreground font-bold mb-1">Move Selected To</p>
