    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-foreground">Expense & P&L Tracker</h2>
                    <p className="text-sm text-muted-foreground">Monitor flow, track expenses, and view real-time profitability.</p>
                </div>
                <div className="flex gap-2">
                    <Button variant="outline" className="border-border text-slate-300 hover:text-foreground">
                        <Download className="h-4 w-4 mr-2" />
                        Export P&L
                    </Button>
                    <AddExpenseModal onSuccess={loadData}>
                        <Button className="bg-[hsl(var(--school-accent))] hover:opacity-90 text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-card text-card-foreground border-border/50 p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-foreground font-mono">₦{summary?.inflow.toLocaleString()}</h3>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="bg-card text-card-foreground border-border/50 p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-foreground font-mono">₦{summary?.outflow.toLocaleString()}</h3>
                ...
                <Card className={`bg-card text-card-foreground border-border/50 p-6 relative overflow-hidden`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Chart */}
                <Card className="lg:col-span-1 bg-card text-card-foreground border-border/50 p-6 h-[400px] flex flex-col">
                ...
                <Card className="lg:col-span-2 bg-card text-card-foreground border-border/50 p-6 h-[400px]">
                    <h3 className="text-lg font-bold text-foreground mb-6">Recent Outflows</h3>
