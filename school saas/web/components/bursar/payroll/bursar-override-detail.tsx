...
export const BursarOverrideDetail: React.FC<BursarOverrideDetailProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-[#0A0A0B] border border-border rounded-3xl overflow-hidden shadow-2xl max-w-2xl w-full animate-in zoom-in-95 slide-in-from-bottom-4 duration-500">
                {/* 🔴 Audit Header */}
                <div className="p-6 bg-red-500/5 border-b border-border/50 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={onClose}
                            className="p-2 hover:bg-secondary/50 rounded-full text-muted-foreground hover:text-foreground transition-all"
                        >
                            <X size={20} />
                        </button>
                    </div>
                ...
                <div className="p-8 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="aspect-video bg-black rounded-2xl border border-border overflow-hidden relative group shadow-inner">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex items-end p-6">
                                <div className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-xl border border-border flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* 🗺️ Telemetry */}
                        <div className="bg-white/[0.02] p-6 rounded-2xl border border-border/50 relative overflow-hidden group">
                    ...
                    <div className="bg-white/[0.01] p-6 rounded-2xl border border-border/50 space-y-3">
                        ...
                        <p className="text-sm text-slate-300 italic leading-relaxed font-medium bg-black/20 p-4 rounded-xl border border-border/50">
                ...
                {/* 🏁 Final Action */}
                <div className="p-8 bg-white/[0.02] border-t border-border/50 flex gap-4">
                    <button
                        onClick={onClose}
