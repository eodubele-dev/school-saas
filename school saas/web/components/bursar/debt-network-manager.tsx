        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-400">Flag parents with outstanding debts to warn other schools on the network.</p>
                </div>
                    ...
                    <DialogContent className="bg-slate-900 border-white/10 text-white sm:max-w-[425px]">
                        ...
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Parent Details</label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Student Details</label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Debt Tier</label>
                                <select
                                    className="flex h-10 w-full rounded-md border border-white/10 bg-slate-950 px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-white"
                                    value={tier}
            ...
            <div className="bg-slate-900 border border-white/10 rounded-xl overflow-hidden">
                {flags.length === 0 ? (
                    ...
                    <div className="divide-y divide-white/5">
                        {flags.map((flag) => (
                            <div key={flag.id} className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors">
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span className="text-slate-500 text-sm">({flag.parent_phone_hash || 'No Phone'})</span>
                                    </div>
