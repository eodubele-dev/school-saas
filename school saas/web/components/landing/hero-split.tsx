        ...
        <section className="relative min-h-[90vh] flex flex-col lg:flex-row items-center justify-center pt-24 pb-12 lg:pt-0 lg:pb-0 overflow-hidden bg-slate-950">
            ...
            <div className="flex-1 w-full max-w-2xl px-6 lg:px-12 xl:pl-24 z-10 flex flex-col gap-6 lg:gap-8 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                    <Button size="lg" className="bg-blue-600 hover:bg-blue-500 text-foreground rounded-full px-8 h-12 text-base shadow-lg shadow-blue-500/20 transition-transform hover:scale-105">
                        Start Free Pilot
                        <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                    <Button size="lg" variant="outline" className="border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-foreground rounded-full px-8 h-12 text-base">
                        Book Executive Demo
                    </Button>
                </div>
            ...
            <div className="flex-1 w-full h-full min-h-[400px] lg:min-h-[500px] relative mt-12 lg:mt-0 flex items-center justify-center p-6 lg:p-12">
                <div className="relative w-full max-w-[600px] group perspective-1000">
                    ...
                    <div className="absolute -bottom-6 -left-6 bg-card text-card-foreground/90 backdrop-blur-md border border-border p-3 rounded-xl shadow-2xl flex items-center gap-3 animate-float delay-1000">
                        <div className="h-10 w-10 bg-green-500/20 rounded-full flex items-center justify-center">
                            <Wallet className="h-5 w-5 text-green-500" />
                        </div>
                        <div>
                            <div className="text-[10px] text-muted-foreground uppercase font-bold">Today's Collection</div>
                            <div className="text-sm font-bold text-foreground">₦450,000</div>
                        </div>
                    </div>
                </div>
            </div>
