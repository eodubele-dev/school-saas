        ...
        <section id="features" className="py-24 relative">
            <div className="container mx-auto px-4">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="text-3xl font-bold text-foreground mb-4">Everything You Need to <span className="text-emerald-green">Gamify Learning</span></h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((f, i) => (
                        <Card key={i} className="bg-obsidian border-border hover:border-white/20 transition-all hover:-translate-y-1 duration-300 group">
                            <CardHeader>
                                <div className={`w-12 h-12 rounded-lg bg-secondary/50 flex items-center justify-center mb-4 group-hover:${f.glow} transition-shadow duration-500`}>
