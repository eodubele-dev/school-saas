            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            {/* Inner Glow / Screen */}
                            <div className="absolute inset-0 bg-black rounded-[2.5rem] overflow-hidden border border-border/50 relative">
                                {/* Status Bar (Fake) */}
                                <div className="absolute top-0 w-full h-8 flex justify-between px-6 pt-3 z-30">
                                    <div className="text-[10px] text-foreground font-medium">9:41</div>
                                ...
                                {/* App UI - Header */}
                                <div className="pt-12 px-6 pb-6 bg-[#0B1221] border-b border-border z-20 relative">
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-foreground font-bold">E</div>
                                        <div>
                                            <h3 className="text-foreground text-sm font-bold">EduCare High</h3>
                                            <p className="text-muted-foreground text-xs">Term 2 Result Sheet</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/50 border border-border/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-foreground text-xs font-bold">Chioma Okeke</div>
                                ...
                                <div className="absolute inset-0 top-[100px] z-30 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-transparent via-black/80 to-black">
                                    <div className="w-full bg-[#1e293b]/90 backdrop-blur-xl border border-border p-6 rounded-2xl flex flex-col items-center text-center shadow-2xl">
                                        <div className="w-12 h-12 rounded-full bg-red-500/20 flex items-center justify-center mb-4">
                                            <Lock className="w-6 h-6 text-red-500" />
                                        </div>
                                        <h4 className="text-foreground font-bold text-lg mb-1">Result Locked</h4>
                                        ...
                                        <div className="text-2xl font-bold text-foreground mb-6 text-glow-cyan">₦45,000</div>

                                        <button className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-foreground font-bold rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.4)] animate-pulse flex items-center justify-center gap-2 transition-all">
                                    ...
                                    <div className="mt-6 bg-[#0B1221] border border-emerald-500/30 p-3 rounded-lg shadow-xl flex items-center gap-3 animate-bounce-slow min-w-[200px]">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[10px] text-muted-foreground">Just now • Via Transfer</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className={`inline-flex items-center gap-3 px-4 py-2 rounded-2xl border transition-all duration-700 max-w-fit ${highlightedSection === 'revenue-engine' ? 'bg-emerald-500/20 border-emerald-400 shadow-[0_0_30px_rgba(16,185,129,0.4)] scale-105' : 'bg-secondary/50 border-border'}`}>
