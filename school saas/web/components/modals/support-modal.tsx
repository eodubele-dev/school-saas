...
export function SupportModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="bg-[#0A0A0B] border-border text-foreground max-w-md overflow-hidden p-0 gap-0">
                <div className="p-6 border-b border-border/50 bg-white/[0.02]">
                    <div className="flex items-center gap-2 mb-2">
                        <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-[0.2em]">Platinum Priority Uplink</span>
                    </div>
                    <DialogHeader>
                        <DialogTitle className="text-2xl font-bold tracking-tight text-foreground italic">Direct Access Terminal</DialogTitle>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/50 border border-border/50">
                        <div className="relative">
                            <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-foreground text-sm">EO</div>
                            <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-emerald-500 border-2 border-[#0A0A0B]" />
                        </div>
                        <div>
                            <div className="font-bold text-foreground text-sm">Emmanuel O.</div>
                            <div className="text-[10px] text-muted-foreground">Platinum Success Lead</div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <div className="font-bold text-foreground text-xs tracking-wide">WhatsApp Direct</div>
                            <div className="text-[10px] text-muted-foreground font-medium">Encrypted executive messaging</div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <div className="font-bold text-foreground text-xs tracking-wide">Email Uplink</div>
                            <div className="text-[10px] text-muted-foreground font-medium">Official support ticketing</div>
                        </div>
                        <ExternalLink className="h-3.5 w-3.5 text-slate-600 group-hover:text-blue-400 transition-colors" />
                    </button>

                    {/* Voice Support (Locked) */}
                    <div className="group flex items-center gap-4 p-4 rounded-2xl bg-secondary/50 border border-border/50 opacity-50 cursor-not-allowed grayscale">
                        <div className="p-2.5 rounded-xl bg-slate-800 text-muted-foreground">
                            <Phone className="h-5 w-5" />
                        </div>
                        <div className="flex-1">
                            <div className="font-bold text-muted-foreground text-xs tracking-wide flex items-center gap-2">
                                Voice Consultation
                                <span className="text-[8px] bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground font-mono uppercase">LTS ONLY</span>
                            </div>
