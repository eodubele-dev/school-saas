    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                <div>
                    <h1 className="text-3xl md:text-5xl font-black italic tracking-tighter uppercase text-foreground mb-2 leading-none">
                ...
                <div className="flex items-center gap-4">
                    <div className="bg-card text-card-foreground border border-border/50 rounded-2xl p-4 flex flex-col items-end">
                        <p className="text-muted-foreground text-[9px] font-bold uppercase tracking-widest mb-1">Total Family Balance</p>
            ...
            <div className="space-y-12">
                ...
                <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        ...
                        <div className="bg-card text-card-foreground/50 border border-border/50 rounded-3xl p-6 backdrop-blur-sm">
                            ...
                            <p className="text-[10px] text-muted-foreground mt-2">Requires attention to prevent arrears.</p>
                        </div>
                        ...
                        <div className="bg-card text-card-foreground/50 border border-border/50 rounded-3xl p-6 backdrop-blur-sm">
                            ...
                            <p className="text-[10px] text-muted-foreground mt-2">Majority of services are active.</p>
                        </div>
                    </div>
                                    ...
                                    <div className="w-full">
                                        ...
                                        <div className="bg-card text-card-foreground/30 border border-border/50 rounded-[2rem] p-6 h-full min-h-[300px]">
                                            <div className="space-y-4">
                                                {[1, 2].map(i => (
                                                    <div key={i} className="flex justify-between items-center p-3 bg-slate-950/50 rounded-xl border border-border/50 group hover:border-emerald-500/30 transition-all">
                                                        <div className="flex items-center gap-3">
                                                            <div className="p-2 rounded-lg bg-card text-card-foreground text-muted-foreground">
                                                                <CreditCard size={14} />
                                                            </div>
                                                            <div>
                                                                <p className="text-xs font-bold text-foreground truncate max-w-[120px]">Tuition Payment</p>
                                                                <p className="text-[9px] text-muted-foreground font-mono tracking-tighter">OCT 12 • REF-8273{i}</p>
                                                            </div>
                                                        </div>
            ...
            {familyLedger.totalBalance > 0 && (
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[95%] max-w-4xl bg-[#0f1014]/90 backdrop-blur-xl border border-border p-4 rounded-2xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 z-50 animate-in slide-in-from-bottom-10">
                    <div className="text-center sm:text-left">
                        <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest mb-0.5">Consolidated Family Summary</p>
                        <div className="flex items-baseline gap-2 justify-center sm:justify-start">
                            <span className="text-muted-foreground text-sm">Total Outstanding:</span>
                            <span className="text-xl font-black text-foreground">₦{familyLedger.totalBalance.toLocaleString()}</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl text-foreground font-black text-sm uppercase tracking-widest shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all flex items-center justify-center gap-2"
                    >
